---
title: 解决FastGPT创建分类问题应用时的307状态码报错
slug: /zh/troubleshoot/fastgpt-307-classify-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1032
source_type: GitHub issue
---

# 解决FastGPT创建分类问题应用时的307状态码报错
...
> 在FastGPT私有部署环境中，用户新建「问题分类+知识库」类型的应用时，即使使用默认模板仍触发报错。查看容器日志可发现固定错误格式：`[ERROR] 2024-03-20 16:51:16 sse error: bad_response_status_code (request id: 2024032100511589425293781505320)`，具体错误详情为`307 (request id: 2024032100511589425293781505320)`，同时
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1032)
