---
title: 解决FastGPT私有部署text-embedding-ada-002不支持协议方案错误
slug: /zh/troubleshoot/fastgpt-ada-protocol-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/986
source_type: GitHub issue
---

# 解决FastGPT私有部署text-embedding-ada-002不支持协议方案错误
...
> FastGPT 4.6.8及最新release私有部署版本中，添加应用后可正常对话，但添加知识库后一直处于索引中，后台持续发起请求。日志报错显示`unsupported protocol scheme ""`，具体报错文本为`Post "text-embedding-ada-002/openai/deployments/Embedding-V1/embeddings?api-version=2023-06-01-preview": unsupported protocol s
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/986)
