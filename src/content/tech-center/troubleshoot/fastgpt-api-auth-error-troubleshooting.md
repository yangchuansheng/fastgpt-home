---
title: FastGPT API访问返回凭证错误的排查与解决方法
slug: /zh/troubleshoot/fastgpt-api-auth-error-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/240
source_type: GitHub issue
---

# FastGPT API访问返回凭证错误的排查与解决方法
...
> 使用FastGPT公有云版本调用API时，返回固定格式的报错信息： ```json { "code": 403, "statusText": "unAuthorization", "message": "凭证错误", "data": null } ``` 用户已多次新建APIKey并确认APIKey、AppID均无异常。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/240)
