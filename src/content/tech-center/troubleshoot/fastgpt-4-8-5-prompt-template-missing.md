---
title: FastGPT 4.8.5版本AI高级编排提示模板缺失排查与解决
slug: /zh/troubleshoot/fastgpt-4-8-5-prompt-template-missing
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2002
source_type: GitHub issue
---

# FastGPT 4.8.5版本AI高级编排提示模板缺失排查与解决
...
> 用户在私有部署FastGPT 4.8.5版本后，登录系统进入AI高级编排页面，无法找到提示模板相关的功能入口或配置项，对应截图显示页面无相关模块。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2002)
