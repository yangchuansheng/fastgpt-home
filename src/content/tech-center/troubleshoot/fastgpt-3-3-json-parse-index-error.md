---
title: FastGPT 3.3版本JSON解析错误及知识库索引问题排查
slug: /zh/troubleshoot/fastgpt-3-3-json-parse-index-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2426
source_type: GitHub issue
---

# FastGPT 3.3版本JSON解析错误及知识库索引问题排查
...
> FastGPT 3.3私有部署版本的docker后台日志反复出现报错：`SyntaxError: Unexpected token '根', "根据提供的历史记录和"... is not valid JSON`，报错堆栈指向JSON.parse解析失败。同时知识库索引过程会卡住，使用m3e模型时出现该问题，更换为其他embedding模型后索引恢复正常。用户使用的设备为M1 Pro 16GB RAM，m3e模型生成嵌入耗时约5分钟。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2426)
