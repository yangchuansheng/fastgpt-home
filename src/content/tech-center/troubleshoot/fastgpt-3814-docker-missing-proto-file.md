---
title: 解决FastGPT 3.8.14版本Docker启动缺失schema.proto文件的问题
slug: /zh/troubleshoot/fastgpt-3814-docker-missing-proto-file
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3245
source_type: GitHub issue
---

# 解决FastGPT 3.8.14版本Docker启动缺失schema.proto文件的问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 3.8.14；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 用户将FastGPT升级至3.8.14私有部署版本后，Docker容器无法正常启动。启动日志中出现如下报错： ``` Init system error Error: ENOENT: no such file or directory, open '/app/projects/app/.next/proto/proto/schema.proto' at Object.openSync (node:fs:573:18) at Object.readFileSync (node:
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3245)
