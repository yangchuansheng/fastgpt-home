---
title: 解决FastGPT 4.9.1私有部署新增模型渠道报错问题
slug: /zh/troubleshoot/fastgpt-4-9-1-model-channel-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4319
source_type: GitHub issue
---

# 解决FastGPT 4.9.1私有部署新增模型渠道报错问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 4.9.1；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 本地源码部署FastGPT 4.9.1私有版时，新增模型渠道出现报错。运行日志包含以下内容： - 接口路由编译完成提示，如`Compiled /api/aiproxy/[...path]` - React组件警告：`Warning: forwardRef render functions accept exactly two parameters: props and ref. Did you forget to use the ref parameter?` - 页面数据量
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4319)
