---
title: 解决FastGPT与新版markerpdf响应格式不兼容的配置问题
slug: /zh/troubleshoot/fastgpt-adapt-markerpdf-response-format
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/5185
source_type: GitHub issue
---

# 解决FastGPT与新版markerpdf响应格式不兼容的配置问题
...
> 用户部署新版markerpdf并接入FastGPT后，调用后收到的markerpdf实际响应格式为： ```json { "format": "markdown", "output": ..... } ``` 而FastGPT默认支持的markerpdf响应格式为： ```json { "success": true, "message": "", "markdown": ..... } ``` 两者的字段结构不匹配，导致FastGPT无法正常解析返回内容，出现功能异常。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/5185)
