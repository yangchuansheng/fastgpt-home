---
title: 解决FastGPT中AI回复最小数量无法自定义设置的问题
slug: /zh/troubleshoot/fastgpt-adjust-reply-min-count
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1603
source_type: GitHub issue
---

# 解决FastGPT中AI回复最小数量无法自定义设置的问题
...
> 用户在FastGPT私有部署的AI回复模块中，无法将最小回复数量设置为小于100的数值，且项目根目录下的config.json配置文件中无对应配置项。使用AI对话模块作为判别器时，无法稳定输出仅1或2的单字符分类结果，当前内置的问题分类模块也不支持引用知识库内容。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1603)
