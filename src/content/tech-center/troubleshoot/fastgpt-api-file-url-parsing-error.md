---
title: 排查并解决FastGPT通过API发送链接文件无法解析的问题
slug: /zh/troubleshoot/fastgpt-api-file-url-parsing-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4299
source_type: GitHub issue
---

# 排查并解决FastGPT通过API发送链接文件无法解析的问题
...
> 用户通过API调用FastGPT时，配置为`file_url`类型的文件无法被正常解析。使用浏览器在线调试上传同一文件，则可以正常完成解析。API调用返回的流程日志中，系统提示包含`Invalid PDF structure.`的错误信息，最终AI回复提示文件无法读取。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4299)
