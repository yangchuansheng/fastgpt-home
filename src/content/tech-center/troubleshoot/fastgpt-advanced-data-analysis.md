---
title: FastGPT 高级数据分析功能缺失的排查与实现指引
slug: /zh/troubleshoot/fastgpt-advanced-data-analysis
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2776
source_type: GitHub issue
---

# FastGPT 高级数据分析功能缺失的排查与实现指引
...
> 当前在FastGPT中，无法通过上传数据文件的方式，使用自然语言完成数据分析、数据合并、图表生成、交互式表格展示等任务，无法实现端到端的自然语言数据分析流程，也无法减少对外部数据分析工具的依赖。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2776)
