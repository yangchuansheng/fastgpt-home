---
title: 解决FastGPT私有部署4.8.13版本数据集插入的401报错问题
slug: /zh/troubleshoot/fastgpt-401-dataset-insert-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3219
source_type: GitHub issue
---

# 解决FastGPT私有部署4.8.13版本数据集插入的401报错问题
...
> 在FastGPT 4.8.13私有部署版本中，执行数据集数据插入操作时触发`Embedding Error`报错，调用`/api/core/dataset/data/insertData`接口返回401错误。日志中出现多条`message: '401 (request id: xxx)'`的报错栈信息，示例请求ID为`202411231141364118978567JpXGoQl`。
