---
title: 解决FastGPT API调用时同chatId全局变量失效的问题
slug: /zh/troubleshoot/fastgpt-api-chatid-global-variable-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2406
source_type: GitHub issue
---

# 解决FastGPT API调用时同chatId全局变量失效的问题
...
> 在FastGPT 4.8.9私有部署版本中，用户通过HTTP获取热搜更新全局变量，并配置仅历史记录为空时触发HTTP模块的分支。免登陆窗口调用正常，首次对话可成功更新全局变量，后续对话的system提示词均能正常使用该变量。但使用API调用时，在同一个chatId下的第二轮对话中，system提示词内的全局变量失效。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2406)
