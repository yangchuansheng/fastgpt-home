---
title: 解决FastGPT私有部署v4.8.7的聚合慢操作报错问题
slug: /zh/troubleshoot/fastgpt-aggregate-slow-error
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2253
source_type: GitHub issue
---

# 解决FastGPT私有部署v4.8.7的聚合慢操作报错问题
...
> 用户在FastGPT私有部署v4.8.7版本调用`/api/v1/chat/completions`接口时，系统日志出现多条`Slow operation`报错，具体报错信息为`Slow operation 366ms`、`Slow operation 368ms`、`Slow operation 370ms`、`Slow operation 384ms`，伴随的错误详情为`{ message: { query: null, op: 'aggregate', duration
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2253)
