---
title: 解决FastGPT私有部署版本API传base64图片无响应问题
slug: /zh/troubleshoot/fastgpt-api-base64-image-no-response
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3196
source_type: GitHub issue
---

# 解决FastGPT私有部署版本API传base64图片无响应问题
...
> 在FastGPT v4.8.13-fix私有部署版本中，使用OpenAI格式的API请求智能体时，以base64格式传图无法正常获取响应。以URL格式传图则可以正常得到响应。用户通过Python代码调用API时，已正确配置OPENAI_BASE_URL和OPENAI_API_KEY环境变量指向目标智能体。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3196)
