---
title: 解决FastGPT对话回复无法添加和展示图片的问题
slug: /zh/troubleshoot/fastgpt-add-image-replies
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/358
source_type: GitHub issue
---

# 解决FastGPT对话回复无法添加和展示图片的问题
...
> 使用FastGPT进行对话交互时，生成的回复仅能展示纯文本内容，无法插入或展示图片类媒体信息，无法通过图片传递更多细节、情感或可视化内容，无法覆盖美工素材库、教育培训、医疗诊断、旅游攻略、菜谱分享、数据分析报告、新闻报道、社交媒体营销等需要图片辅助的应用场景。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/358)
