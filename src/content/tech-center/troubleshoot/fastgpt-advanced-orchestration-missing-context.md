---
title: 解决FastGPT高级编排调用应用后免登录窗口无上下文引用问题
slug: /zh/troubleshoot/fastgpt-advanced-orchestration-missing-context
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1957
source_type: GitHub issue
---

# 解决FastGPT高级编排调用应用后免登录窗口无上下文引用问题
...
> 1. 高级编排中使用工具调用+应用调用、问题分类+应用调用的组合场景下，免登录窗口无法显示上下文引用 2. 调试界面、立即对话界面的上下文显示正常 3. 发布应用时已勾选「返回引用」配置项 4. 直接调用被编排的目标应用时，其免登录窗口可正常显示上下文引用
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1957)
