---
title: 解决FastGPT 4.7版本关联知识库时的随机报错与崩溃问题
slug: /zh/troubleshoot/fastgpt-47-kb-error-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1379
source_type: GitHub issue
---

# 解决FastGPT 4.7版本关联知识库时的随机报错与崩溃问题
...
> 私有部署版本4.7的FastGPT中，会随机出现两种异常：一是接口返回【400 Unsupported model:】错误，二是后台触发【Panic detected, error: runtime error: invalid memory address or nil pointer dereference】的崩溃报错。在知识库上传文档进行索引时，约半数数据会失败，页面持续显示"索引中"状态；聊天功能在未关联知识库时无异常，关联知识库后会随机触发上述两种报错。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1379)
