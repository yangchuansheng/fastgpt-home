---
title: FastGPT 4.8.20私有部署bge-reranker-v2-m3失效的排错方法
slug: /zh/troubleshoot/fastgpt-4820-bge-reranker-troubleshooting
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3694
source_type: GitHub issue
---

# FastGPT 4.8.20私有部署bge-reranker-v2-m3失效的排错方法
...
> 用户在本地通过docker部署bge-reranker-v2-m3模型，升级至FastGPT 4.8.20私有部署版本后，该模型无法正常使用，此前版本运行正常，用户附带了多张相关报错截图。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3694)
