---
title: FastGPT部分API接口403未授权调用问题排查
slug: /zh/troubleshoot/fastgpt-api-403-unauthorized-issue
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/567
source_type: GitHub issue
---

# FastGPT部分API接口403未授权调用问题排查
...
> 1. 调用`api/core/chat/item/delete`删除聊天记录接口时，使用应用apikey、全局通用key、rootkey均返回403 unAuthorization错误，无法正常请求； 2. 调用`api/core/chat/feedback/userUpdate`反馈建议接口时，无需携带任何token即可正常请求； 3. 调用`api/core/ai/agent/createQuestionGuide`下一步引导接口时，使用root_key可正常请求，但使用
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/567)
