---
title: 解决FastGPT API返回200状态码但无返回数据的问题
slug: /zh/troubleshoot/fastgpt-api-200-no-data
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/4133
source_type: GitHub issue
---

# 解决FastGPT API返回200状态码但无返回数据的问题
...
> 用户调用FastGPT API时，请求返回HTTP 200状态码，但响应无有效数据。用户表示请求内容是按照FastGPT API示例规范编写的，确认自身API Key可用，且应用appId=67ce56d4a7e90d9636775c57内存在对应数据，使用HTTP请求工具发起请求，无论请求中是否携带source参数，均出现该问题。用户需求为通过API获取免登陆窗口的聊天记录，但未得到预期数据。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/4133)
