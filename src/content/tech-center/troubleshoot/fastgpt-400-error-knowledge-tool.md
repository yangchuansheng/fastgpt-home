---
title: 解决FastGPT挂载知识库或工具后返回400错误的问题
slug: /zh/troubleshoot/fastgpt-400-error-knowledge-tool
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/1046
source_type: GitHub issue
---

# 解决FastGPT挂载知识库或工具后返回400错误的问题

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 v4.7、v0.6.3-alpha.1；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 用户使用FastGPT v4.7、OneAPI v0.6.3-alpha.1的私有部署版本，在应用中挂载知识库或工具后，发起聊天会触发报错。移除挂载的知识库或工具后，聊天功能可正常使用。报错日志具体内容为： ``` [ERROR] 2024-03-21 16:51:24 sse error: bad_response_status_code bad response status code 400 (request id: 20240322005124590192451614
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/1046)
