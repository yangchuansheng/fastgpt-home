---
title: 解决FastGPT外部API调用返回504网关超时的问题
slug: /zh/troubleshoot/fastgpt-api-504-gateway-timeout
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/681
source_type: GitHub issue
---

# 解决FastGPT外部API调用返回504网关超时的问题
...
> 用户通过外部API调用FastGPT私有部署版本的应用时，当应用整体运行时长约50秒，API请求会返回包含“504 Gateway Time-out”的HTML报错，报错来源为nginx。FastGPT后台服务运行正常，请求可在应用对话日志中查看。调用耗时10秒左右的应用时，无此报错问题。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/681)
