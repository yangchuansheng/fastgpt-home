---
title: FastGPT API批量导入知识库数据索引后重复问题排查
slug: /zh/troubleshoot/fastgpt-api-batch-duplicate-index
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/2329
source_type: GitHub issue
---

# FastGPT API批量导入知识库数据索引后重复问题排查
...
> 通过API批量添加的知识库数据，在创建训练订单时无异常，但完成索引操作后，知识库中出现重复的数据条目。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/2329)
