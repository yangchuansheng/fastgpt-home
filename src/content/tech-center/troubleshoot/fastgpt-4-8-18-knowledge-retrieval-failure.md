---
title: FastGPT 4.8.18及以上版本部分知识库无法检索的排错方法
slug: /zh/troubleshoot/fastgpt-4-8-18-knowledge-retrieval-failure
page_type: 故障排查
source: https://github.com/labring/FastGPT/issues/3736
source_type: GitHub issue
---

# FastGPT 4.8.18及以上版本部分知识库无法检索的排错方法

## 适用环境与版本范围

- **环境：** FastGPT deployment environment described by the maintainer source
- **版本范围：** 维护者记录涉及 4.8.17、4.8.18、4.8.20、4.8.14；应用前请在目标环境确认实际 FastGPT 与相关组件版本。
- **适用边界：** 这篇说明只覆盖公开维护者来源中记录的现象。先核对部署方式、相关组件和请求入口，再执行处理步骤。

## 问题指纹

> 用户将FastGPT从4.8.17升级到4.8.18及后续版本（如4.8.20）后，原本在4.8.17及更早版本可正常检索的某一个知识库无法参与检索。通过逐小版本升级验证，确认该问题在升级至4.8.18版本后首次出现，4.8.14至4.8.17版本均可正常检索该知识库。
...
> 来源：[FastGPT maintainer source](https://github.com/labring/FastGPT/issues/3736)
