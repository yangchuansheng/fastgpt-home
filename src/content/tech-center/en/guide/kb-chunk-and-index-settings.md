...
source: https://github.com/labring/FastGPT/blob/v4.16.2/packages/global/core/dataset/training/utils.ts
source_type: Open-source repository v4.16.2
article_section: Configuration and tuning
is_part_of: FastGPT Technical Center
...
- [Knowledge base retrieval pipeline: how one question becomes a few quotes](/en/guide/kb-retrieval-pipeline)
