...
**内容咨询入口**:
技术中心、指南文章、Blog 文章与 FAQ 详情页中引导读者进入商务咨询页、提交业务需求的转化入口。
_Avoid_: 留资 CTA, 咨询按钮
...
**Blog 索引**:
以发布日期组织 FastGPT 产品动态与编辑型技术内容的独立出版集合，与任务型技术中心、企业决策与实施指南并列。
_Avoid_: 技术中心, 指南索引, 资源中心

**Blog 分类**:
每篇 Blog 文章唯一的主编辑分类，取值为“产品上新”或“技术干货”；混合内容按核心搜索意图归类。
_Avoid_: 主题标签, 技术中心分类

**Blog 文章**:
在 Blog 索引中发布、具有发布日期并唯一归属一个 Blog 分类的编辑内容。
_Avoid_: 指南文章, 技术页

**产品上新**:
帮助读者理解 FastGPT 新版本、新功能或新集成的 Blog 分类。
_Avoid_: 版本文档, 更新日志

**技术干货**:
帮助读者解决技术问题或理解技术方法，并结合 FastGPT 实践的 Blog 分类。
_Avoid_: 操作文档, 企业选型指南
